...
@Component
@Transactional
public class LEventActReceiverService
{
	@Autowired
	JdbcDao jdbcDao;
	...
	public String create(String eventid, String receiver, String receivercname, String receiverctype) throws Exception
	{
		...
		sql.append("insert into t_sys_wfleventact_receiver (id, receiver, receivercname, receiverctype, eventid) values (" + SQLParser.charValue(id) + "," + SQLParser.charValue(receiver) + "," + SQLParser.charValue(receivercname) + "," + SQLParser.charValue(receiverctype) + "," + SQLParser.charValue(eventid) + ")");
