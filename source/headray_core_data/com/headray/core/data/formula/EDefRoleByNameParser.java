...
public class EDefRoleByNameParser
{
	...
	public String parserSQL(JdbcTemplate jt, String formula_str) throws Exception
	{
		...
		sql.append(" ( ");
		sql.append(" " + SQLParser.charValue(rolename) + " in (select a.cname from t_sys_xrole a, t_sys_groupuser b where 1 = 1 and a.roleid = b.groupid and b.grouptype = 'ROLE' and b.personid = " + SQLParser.charValue(personid) + " ) ");
		sql.append(" ) ");
