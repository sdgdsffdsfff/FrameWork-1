...
function page_save()
{
	...
	$.post("${base}/module/app/system/workflow/bform/bform_isclassid.action",
				...
				function(data){
					eval("var data = "+data + ";");
					if(data == true){
						$("#locateform").attr('action','bform_update.action');
...
<input type="hidden" id="id" name="id" value="${data.bform.id}">

<table class="formGrid">
	<tr> 
		<td class="r"><label for="cname">表单名称：</label></td>
		<td><input type="text" class="text required" id="cname" name="cname" style="width:20em;" value="${data.bform.cname}" ></td>
		<td class="r">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>	
	<tr>
		<td class="r"><label for="url">表单URL地址：</label></td>
		<td><input type="text" class="text required" id="url" name="url" style="width:20em;" value="${data.bform.url}" ></td>				
		<td class="r">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>	
	<tr>
		<td class="r"><label for="classname">分类名称：</label></td>
		<td><input type="text" class="text required" id="classname" name="classname" style="width:20em;" value="${data.classname}" ></td>				
		<td class="r">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>		
	 <tr>
		<td class="r"><label for="descript">说明：</label></td>
		<td colspan="3"><textarea class="text" id="descript" name="descript" value="${data.bform.descript}" style="width:50em;" maxlength="500">${data.bform.descript}</textarea></td>				
		<td class="r">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>		
</table>
