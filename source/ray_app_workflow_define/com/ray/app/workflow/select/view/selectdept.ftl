...
<body>
	<form>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr height="25">
				<td>
				<div style="float:left;line-height:25px;">待选部门 ：</div>
				<div style="float:right;"><input  name="inputname" Value="" class="text fullWidth"><button onclick="google();">部门查询</button></div>		 
				</td>
			</tr>
			<tr>
				...
				<#list data.optstr as organ>
					<option value="${organ.id}">${organ.cname}
				</#list> 
				</select>
				</td>
			</tr>
