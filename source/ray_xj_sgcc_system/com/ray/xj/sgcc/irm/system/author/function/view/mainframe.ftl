...
//初始化根节点
//$('#leftTreeDiv').append('<ul id="gAjaxTree">'+ajax4Tree_pz1('${base}/module/irm/system/author/function/function_tree.action',rootID)+'</ul>');
...
$('#gAjaxTree li span').live('click',function()
{
    ...
    {
		obj.append('<ul>'+ajax4Tree_pz1('${base}/module/irm/system/author/function/function_treechild.action',obj.attr('data-id'))+'</ul>')
    }
    else
    {
        obj.find('ul').toggle();	
	...
	window.rightIframe.location='${base}/module/irm/system/author/function/function_browse.action?_searchname=system.author.function.browse&fnum='+obj.attr('data-id');	
