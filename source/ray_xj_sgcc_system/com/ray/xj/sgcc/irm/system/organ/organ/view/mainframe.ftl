...
$('#gAjaxTree li span').live('click',function(){
	...
	window.rightIframe.location='${base}/module/irm/system/organ/organ/organ_browse.action?_searchname=system.organ.organ.browse&parentorganid='+obj.attr('data-id');	
