...
function page_view_row_dbclick(keyname, keyvalue, index)
{
	...
	url = "${base}/module/irm/system/organ/role/role_locateframe.action?_searchname=system.organ.role.locate";
...
function page_delete()
{
	...
	{
		url = "${base}/module/irm/system/organ/role/role_delete.action?id="+currentkey;
		window.location = url;
	}
}
