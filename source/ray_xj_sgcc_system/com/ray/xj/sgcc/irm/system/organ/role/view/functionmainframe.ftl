...
//初始化根节点
//$('#leftTreeDiv').append('<ul id="gAjaxTree">'+ajax4Tree_pz1('${base}/module/irm/system/organ/role/role_tree.action',rootID)+'</ul>');
...
$('#gAjaxTree li span').live('click',function()
{
    ...
    {
		obj.append('<ul>'+ajax4Tree_pz1('${base}/module/irm/system/organ/role/role_treechild.action',obj.attr('data-id'))+'</ul>')
    }
    else
    {
        obj.find('ul').toggle();	
	...
	window.rightIframe.location='${base}/module/irm/system/organ/role/role_browsefunction.action?_searchname=system.organ.role.browsefunction&roleid=${arg.roleid}&fnum='+obj.attr('data-id');	
...
<ul id="gAjaxTree">
	<li data-pid="0000" data-index="1" data-parent="" data-leaf="1" data-id="A000"><span class="root">运维资源管理系统</span></li>
