...
//初始化根节点
//$('#leftTreeDiv').append('<ul id="gAjaxTree">'+ajax4Tree_pz1('${base}/module/irm/system/organ/user/user_tree.action',rootID)+'</ul>');
...
$('#gAjaxTree li span').live('click',function(){
	...
	window.rightIframe.location='${base}/module/irm/system/organ/user/user_browse.action?_searchname=system.organ.user.browse&organid='+obj.attr('data-id');	
