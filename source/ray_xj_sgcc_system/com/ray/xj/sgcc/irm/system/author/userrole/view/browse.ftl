...
function page_view_row_dbclick(keyname, keyvalue, index)
{
	...
	url = "${base}/module/irm/system/author/userrole/userrole_locate.action?_searchname=system.author.userrole.locate";
...
function page_delete()
{
	...
	{
		url = "${base}/module/irm/system/author/userrole/userrole_delete.action?id="+currentkey;
		window.location = url;
	}
}
...
function page_input()
{
	url = "${base}/module/irm/system/author/userrole/userrole_input.action?_searchname=system.author.userrole.input";
	window.location = url;
}
