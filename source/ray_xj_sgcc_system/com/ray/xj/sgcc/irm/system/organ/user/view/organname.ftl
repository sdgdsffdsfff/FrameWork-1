...
$.ajax({
    ...
    success:function(d){
        ...
        $.each(d,function(j,k){
			...
			ohtml+='<li data-id="'+k.id+'" data-leaf="'+k.leaf+'" data-deptname="'+k.deptname+'" data-deptallname="'+k.deptallname+'" data-deptid="'+k.deptid+'"><span class="'+otype+'" title="'+k.name+'">'+k.name+'</span></li>';
        })
